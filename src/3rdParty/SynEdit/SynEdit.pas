...
$Id: SynEdit.pas,v 1.1.1.1 2004/02/20 08:18:25 anoncvs Exp $
...
{end}                                                                           //mh 2000-10-19
        ScrollInfo.nPage := Max(CharsInWindow,0);                               //Gp 2002-11-29
...
begin
  ...
  if (ssoSelectedOnly in AOptions) then begin
    ...
    if bBackward then ptCurrent := ptEnd else ptCurrent := ptStart;
{begin}                                                                         //Gp 2002-09-19
//    if (not bBackward) and (CaretX                                            Y.X = BlockEnd.X) and (CaretXY.Y= BlockEnd.Y) then
//      ptStart := BlockBegin;
{end}                                                                           //Gp 2002-09-19
  end;
