...
$Id: SynEditHighlighter.pas,v 1.1.1.1 2004/02/20 08:18:25 anoncvs Exp $
...
type
  ...
  protected
    ...
    function PropGetCapabilities: TSynHighlighterCapabilities; virtual;
    function PropGetLanguageName: string; virtual;
  public
...
{$ENDIF}
    ...
    property LanguageName: string read PropGetLanguageName;
  public
    property AttrCount: integer read GetAttribCount;
    property Attribute[idx: integer]: TSynHighlighterAttributes
      read GetAttribute;
    property Capabilities: TSynHighlighterCapabilities read PropGetCapabilities;
...
function TSynCustomHighlighter.PropGetLanguageName: string;
begin
  Result := GetLanguageName;
end;

function TSynCustomHighlighter.PropGetCapabilities: TSynHighlighterCapabilities;
begin
