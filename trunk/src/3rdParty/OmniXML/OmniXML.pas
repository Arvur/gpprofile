{ $OmniXML: OmniXML/OmniXML.pas,v 1.25 2007/10/09 15:44:39 mremec Exp $ }
...
function TXMLElement.GetNodeName: WideString;
begin
  Result := GetTagName;
end;
...
function TXMLProcessingInstruction.GetNodeName: WideString;
begin
  Result := FTarget;
end;
...
procedure TXMLAttr.SetName(const Value: WideString);
begin
...
function TXMLAttr.GetNodeName: WideString;
begin
  Result := GetName;
end;
...
function TXMLCharacterData.GetNodeValue: WideString;
begin
  Result := FNodeValue;
end;
...
function TXMLText.GetNodeName: WideString;
begin
  Result := '#text';
end;
...
function TXMLCDATASection.GetNodeName: WideString;
begin
...
function TXMLComment.GetNodeName: WideString;
begin
  Result := '#comment';
end;
...
function TXMLDocumentType.GetNodeName: WideString;
begin
  Result := '#doctype';
end;
...
function TXMLDocumentFragment.GetNodeName: WideString;
begin
...
function TXMLDocument.GetNodeName: WideString;
begin
  Result := '#document';
end;
...
var
  ...
  function GetUnclosedTags: WideString;
  begin
    Result := '';
